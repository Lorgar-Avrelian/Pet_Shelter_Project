...
public class InfoServiceImpl implements InfoService {
    ...
    public void checkInfo() {
        ...
        for (String s : infoList) {
            ...
            if (!s.contains("Общие рекомендации о технике безопасности на территории приюта")) {
            ...
            if (!s.contains("Правила знакомства с животным до того, как забрать его из приюта")) {
            ...
            if (!s.contains("Список документов, необходимых для того, чтобы взять животное из приюта")) {
            ...
            if (!s.contains("Список рекомендаций по транспортировке животного")) {
                Info info = new Info(10L, "Список рекомендаций по транспортировке животного", "Список рекомендаций по транспортировке животного");
                infoRepository.save(info);
            }
            if (!s.contains("Список рекомендаций по обустройству дома для щенка")) {
            ...
            if (!s.contains("Список рекомендаций по обустройству дома для котенка")) {
            ...
            if (!s.contains("Список рекомендаций по обустройству дома для взрослого животного с ограниченными возможностями")) {
            ...
            if (!s.contains("Советы кинолога по первичному общению с собакой")) {
                Info info = new Info(14L, "Советы кинолога по первичному общению с собакой", "Советы кинолога по первичному общению с собакой");
                infoRepository.save(info);
            }
            if (!s.contains("Рекомендации по проверенным кинологам для дальнейшего обращения с собакой")) {
            ...
            if (!s.contains("Список причин, почему могут отказать и не дать забрать собаку из приюта")) {
            ...
            if (!s.contains("Форма ежедневного отчета")) {
                Info info = new Info(17L, "Форма ежедневного отчета", "Форма ежедневного отчета");
                infoRepository.save(info);
            }
            if (!s.contains("Поздравление с успешным прохождением испытательного срока")) {
            ...
            if (!s.contains("Назначено дополнительное время испытательного срока")) {
            ...
            if (!s.contains("Уведомление о том, что усыновитель не прошел испытательный срок")) {
